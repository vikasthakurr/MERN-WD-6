...
// step 3: open terminal in vs code and type command npm init -y
// step 4: create a file index.js and write console.log('Hello World')
...
// js is used to create dynamic content on webpages.
// js is used to validate forms.
// js is used to create cookies.
...
// This is your first code in Javascript

// Execution Flow of Javascript program??
// 1. The code is read and parsed by the JavaScript engine.
// 2. The code is compiled into machine code.
// 3. The machine code is executed line by line.
// 4. The console.log statements are executed in order, printing the messages to the console.
// 5. top to bottom execution
